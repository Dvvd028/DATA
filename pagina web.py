# -*- coding: utf-8 -*-
"""Copia de PROYECTO SEGUNDO CORTE.ipynb
...
!streamlit run ProyectoBigData.py & npx localtunnel --port 8501

with tab2:

  st.subheader("Prueba de Hipotesis")

  Formula = r"H_0:\text{no hay diferencia}"
  Formula += r", \\ H_1: text{Existe diferencia}"
  st.latex(Formula)